      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-gray-600">{t('loadingMatch')}</p>
          </div>
        </div>
        <Footer />
      </div>
        ...
        {!theaterMode && (
          <>
            ...
            <main className="container mx-auto px-4 py-6 max-w-7xl">
              ...
              {/* Polls & Voting Section - Show above player on mobile */}
              ...
              {/* Polls & Voting Section - Show under player on desktop */}
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-600">
                    <p className="leading-relaxed">
                      Experience the excitement of <strong className="text-gray-800">{match.clubs.home.name}</strong> vs <strong className="text-gray-800">{match.clubs.away.name }</strong> with our premium HD live streaming service. This {match.competition.name} match brings together two competitive teams 
